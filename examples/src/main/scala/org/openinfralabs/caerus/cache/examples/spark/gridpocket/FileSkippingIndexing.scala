...
object FileSkippingIndexing {
  def main(args: Array[ String ]) {
    ...
    val indexName: String = args(4)

    // Initialize Spark.
    val spark: SparkSession = SparkSession.builder()
      .master(sparkURI)
      .appName(name = "SemanticCacheFileSkippingIndexing")
      .getOrCreate()
    ...
    val bytesWritten = semanticCache.fileSkippingIndexing(loadDF, attributeName, Tier.COMPUTE_MEMORY, name = indexName)
